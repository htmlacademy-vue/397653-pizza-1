        ...
        <div class="content__dough">
          <div class="sheet">
            ...
            <div class="sheet__content dough">
              <label :class="['dough__input', getDoughClass(dough.name)]" v-for="dough in dough" :key="dough.id">
                <input type="radio" name="dought" value="light" class="visually-hidden" :checked="dough.id === 1">
                <b>{{ dough.name }}</b>
        ...
        <div class="content__diameter">
          <div class="sheet">
            ...
            <div class="sheet__content diameter">
              <label :class="['diameter__input', getSizesClass(size.name)]" v-for="size in sizes" :key="size.id">
                <input type="radio" name="diameter" value="small" class="visually-hidden" :checked="size.id === 2">
                <span>{{ size.name }}</span>
              </label>
            </div>
          </div>
            ...
            <div class="sheet__content ingredients">
              <div class="ingredients__sauce">
                ...
                <label class="radio ingredients__input" v-for="sauce in sauces" :key="sauce.id">
                  <input type="radio" name="sauce" :value="getSauceValue(sauce.name)" :checked="sauce.id === 1">
              ...
              <div class="ingredients__filling">
                ...
                <ul class="ingredients__list">
                  <li class="ingredients__item" v-for="ingredient in ingredients" :key="ingredient.id">
                    <span :class="['filling', getIngredientClass(ingredient.name)]">{{ ingredient.name }}</span>
...
import { mapIngredientName, mapSauceName, mapDough, mapSizes } from '@/common/helpers';
export default {
  data() {
    return {
